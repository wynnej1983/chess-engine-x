 ...
 */
function Board(opts) {
  this._options = _.defaults(opts || {}, { isWhiteTurn: true });

  this.squares = [];
  this.captures = [];
  this.isWhiteTurn = this._options.isWhiteTurn;
 ...
 * Empty board FEN
 */
Board.EMPTY_FEN = '8/8/8/8/8/8/8/8 w KQkq - 0 1';
...
Board.prototype.clear = function() {
  //this._fenParse(Board.EMPTY_FEN);
  var dim = Board.SIZE;
  for (var i = 0; i < dim; ++i) {
    var col = [];
    for (var j = 0; j < dim; ++j){
...
Board.Pieces = Board.prototype._pieces;
